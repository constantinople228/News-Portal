...
SECRET_KEY = 'django-insecure-7z1%u_#tk0v8d4s=+n^q!8x+s%&!fw2k)v#1g#5pqtu*wnutw='
...
ADMINS = [
    ('Kosti', 'slobodskoikostya@gmail.com'),
...
EMAIL_PORT = 465
EMAIL_HOST_USER = 'kostyaslobodskoi@yandex.ru'
EMAIL_HOST_PASSWORD = 'ozarogsxprozmsbo'
EMAIL_USE_SSL = True
